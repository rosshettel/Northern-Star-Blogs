...
*/
	...
	$framework_options[] = array( 	"name" => "WordPress Toolbar",
									"icon" => "header",
									"type" => "heading" );

	$framework_options[] = array( 	"name" => "Disable WordPress Toolbar",
									"desc" => "Disable the WordPress Toolbar.",
									"id" => $shortname."_admin_bar_disable",
									"std" => "",
									"type" => "checkbox" );

	$framework_options[] = array( 	"name" => "Enable the WooFramework Toolbar enhancements",
									"desc" => "Enable several WooFramework-specific enhancements to the WordPress Toolbar, such as custom navigation items for 'Theme Options'.",
