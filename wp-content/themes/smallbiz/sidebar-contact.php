	...
	<div id="sidebar">
		<ul>
			<?php 	/* Widgetized sidebar, if you have the plugin installed. */
					if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Sidebar Contact Page') ) : ?>
			<li class="box">
				...
				<p>3) Select a widget and drag it into the "Sidebar Contact Page" area. </p>
					
					<p>The Homepage, Find Us and Blog page have their own sidebar areas. Duplicate your "Contact" widget(s) or add different widgets.</p>
