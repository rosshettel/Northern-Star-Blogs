	...
	<div id="sidebar">
		<ul>
			...
			<li class="box">
				...
				<p>3) Select a widget and drag it into the "Sidebar Find Us Page" area. </p>
				<p>The Homepage, Find Us and Blog page have their own sidebar areas. Duplicate your "Find Us" widget(s) or add different widgets.</p>
