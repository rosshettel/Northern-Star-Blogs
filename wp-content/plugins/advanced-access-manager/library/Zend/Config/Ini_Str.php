 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Config_Ini_Str extends Zend_Config
{
    /**
    ...
    public function __construct($config, $section = null, $options = false)
    {
        if (empty($config)) {
            ...
            throw new Zend_Config_Exception('Config is empty');
        }
        ...
        $iniArray = $this->_loadIniString($config);
     ...
     * @return array
     */
    protected function _parseIniString($config)
    {
        set_error_handler(array($this, '_loadFileErrorHandler'));
        $iniArray = parse_ini_string($config, true); // Warnings and errors are suppressed
     ...
     * @return array
     */
    protected function _loadIniString($filename)
    {
        $loaded = $this->_parseIniString($filename);
        $iniArray = array();
